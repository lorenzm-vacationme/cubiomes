...
int main(int argc, char *argv[]) {
    ...
    // Apply the specified seed to the generator for Nether
    ...
    char outputFile[256];
    snprintf(outputFile, sizeof(outputFile), "%s/nether_seed_%lu.ppm", dirUrl, (unsigned long)seed);
    ...
    printf("Nether biome map generated and saved to %s\n", outputFile);
